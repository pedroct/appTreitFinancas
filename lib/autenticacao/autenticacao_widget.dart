...
class _AutenticacaoWidgetState extends State<AutenticacaoWidget>
  ...
  void initState() {
    ...
    _model.senhaUsuarioTextController ??= TextEditingController();
    _model.senhaUsuarioFocusNode ??= FocusNode();
                                            ...
                                            children: [
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 12.0, 0.0, 24.0),
                                                child: Text(
                                                  'Informe suas credenciais abaixo para ter acesso a aplicação.',
                                              ...
                                              Padding(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: TextFormField(
                                                    controller: _model
                                                        .senhaUsuarioTextController,
                                                    focusNode: _model
                                                        .senhaUsuarioFocusNode,
                                                    autofocus: false,
                                                    autofillHints: const [
                                                      AutofillHints.password
                                                    ],
                                                    obscureText: !_model
                                                        .senhaUsuarioVisibility,
                                                    decoration: InputDecoration(
                                                      labelText: 'Senha',
                                                      labelStyle:
                                                          FlutterFlowTheme.of(
                                                    ...
                                                    cursorColor:
                                                        FlutterFlowTheme.of(
                                                            ...
                                                            .primary,
                                                    validator: _model
                                                        .senhaUsuarioTextControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: Image.asset(
                          'assets/images/Caminho_Financas.png',
                        ).image,
                      ),
